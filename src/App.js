...
class App extends React.Component {
  ...
  render() {
    return (
      <BrowserRouter>
        <Routes>
          <Route path="/" exact element={<Home isLoading={this.isLoading}/>}/>
          <Route path="/browse" exact element={<PlayBrowser addToFavs={this.addToFavs} getPlayList={this.getPlayList}/>}/>
        </Routes>
      </BrowserRouter>
    );
  }
